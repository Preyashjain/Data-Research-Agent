...
export default function RootLayout({ children }: { children: any }) {
  ...
  const [agentId, setAgentId] = useState("data-research-agent");
            ...
            <Layout>
              <Header className="bg-white p-0 flex flex-nowrap">
                ...
                <div className="flex items-center ml-8 flex-none shrink-0">
                  <span className="text-base font-semibold">Data Research Agent</span>
              ...
              <Content className="m-4 p-6 bg-white min-h-[calc(100vh-120px)]">
                  <div className="mb-4 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                    ...
                    <div>LangGraph • LangChain • Python • FastAPI • SQLite • Langfuse</div>
                  </div>
                  {children}
              </Content>
            </Layout>
